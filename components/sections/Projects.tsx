      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-bold mb-6 text-center">
            ...
            <span className="bg-gradient-to-r from-cyan-500 to-blue-500 bg-clip-text text-transparent">{projects.heading.split(' ').slice(-1)[0]}</span>
          </h2>
            ...
            {projectsData.map((project, i) => (
              ...
              >
                ...
                <div className="relative aspect-[4/3] overflow-hidden bg-gray-100 dark:bg-slate-900">
                  ...
                  <div className={`hidden absolute inset-0 bg-gradient-to-br ${project.gradient} items-center justify-center`}>
                ...
                <div className="p-6">
                  ...
                  {project.liveUrl && (
                    <a
                      ...
                      className="inline-flex items-center gap-2 text-cyan-500 hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors text-sm font-medium group-hover:gap-3"
                    >
